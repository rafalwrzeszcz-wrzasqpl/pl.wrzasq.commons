...
class TypedNotificationHandlerTest {
    ...
    fun process() {
        ...
        val message = SNS().apply { message = objectMapper.writeValueAsString(content) }
        ...
        val handler = TypedNotificationHandler(objectMapper, messageHandler, String::class.java)
    ...
    fun processGeneric() {
        ...
        val handler = TypedNotificationHandler(objectMapper, genericMessageHandler, GenericMessage::class.java)
        handler.process(event)
